 ...
 * @author brand
 */
public class pantallaRegistroConsulta extends javax.swing.JFrame {

    /**
     * Creates new form pantallaRegistroConsulta
     */
    public pantallaRegistroConsulta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tipo de Consulta (especialidad):");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pantallaRegistroConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pantallaRegistroConsulta().setVisible(true);
            }
        });
    }
