...
/**
 * Clase de negocio para gestionar las consultas médicas. Esta clase contiene la
 * lógica de negocio para agregar y obtener consultas.
 *
 * @author brand
 */
public class ConsultaBO {
    ...
    /**
     * Agrega una consulta médica. Valida los datos de la consulta y la cita, y
     * luego guarda la consulta en la base de datos.
     *
     * @param consultaNueva Los datos de la nueva consulta (DTO).
     * @param cita La cita asociada a la consulta (Entidad).
     * @return true si la consulta se agregó correctamente, false en caso
     * contrario.
